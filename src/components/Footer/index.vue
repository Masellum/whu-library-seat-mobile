<template>
    ...
    <div class="warper flex-col" @click.stop="openMainBody()">
      ...
      <i v-if="hasToken" class="toggle-button" @click.stop="openUserForm()">
        ...
        <svg class="icon" :class="isLover?(userBtnChecked?'icon-checked-red':'icon-unchecked-red'):(userBtnChecked?'icon-checked':'icon-unchecked')" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><path d="M833.8 939.5H892s-7.7-160.9-95-190c-97.5-32.5-190-45.4-190-76v-57s52.2 23.3 110.4-5.8C819.8 559.5 835 578.5 835 578.5s-88.5-50.5-88.5-142.4 32.7-169.3-25.5-256.6c-58.2-87.3-176-95-209-95-25.2 0-150.8 7.7-209 95-64.2 96.3-22.1 164.7-22.1 256.6 0 91.9-91.9 142.4-91.9 142.4s29.1-13.8 121 32.2c58.2 29.1 107 5.8 107 5.8v57c0 30.6-92 45.4-190 76-98.1 30.6-95 190-95 190h701.8z"></path></svg>
      </i>
      <span style="cursor: default!important;" v-if="hasToken">&nbsp;&nbsp;</span>
...
export default {
  ...
  computed: {
    ...
    isLover () {
      return this.userAccount === 2020301131013
    },
    isDeveloper () {
      return this.userAccount === 2020302181178
    }
    // newVersion () {
